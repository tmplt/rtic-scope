...
*** TODO Port =monitor tpiu config internal itm.bin uart off 16000000=
    ...
    #+END_SRC
    here. [[https://docs.rs/probe-rs/0.10.1/probe_rs/struct.Session.html#method.setup_swv][See documentation]].
...
**** After a =monitor itm port 0 on=:
    ...
    *Deprecated starting from CoreSight v3.0*. Check ~LSR.SLI~ whether
    ...
    The address prefix =0xe0000= is seemingly *not documented* in the
    same document. /Where is it documented?/
